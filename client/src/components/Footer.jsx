...
const Footer = () =>{
    return ( 
    <>
      <footer className="bg-white dark:bg-gray-900 fixed w-full">
            <div className="mx-auto w-full max-w-screen-xl">
                  ...
                  <div className="px-4 py-6 bg-gray-100 dark:bg-gray-800 md:flex md:items-center md:justify-between">
                        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <Link to="https://flowbite.com/">NetixPay™</Link>. All Rights Reserved.
                        </span>
