      ...
      <header className={styles.navbar}>
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
                  ...
                  <Link to="/" className="-m-1.5 p-1.5">
                        ...
                        <img className="h-8 w-auto" src={logo} alt="LogoImage"/>
                  </Link>
                  <Link to='/' className="ps-1 text-xl text-white text-center font-bold">HEALTHHUB</Link>
                  </div>
                  ...
                  <Popover.Group className="hidden lg:flex lg:gap-x-12">
                        ...
                        {
                              !user && (<>
                                    <Link to="/prelogin" className="text-sm font-semibold leading-6 text-white" >Log In</Link>
                                    <Link to="/preregister" className="text-sm font-semibold leading-6 text-white">Register</Link>
                              </>)
                        }
