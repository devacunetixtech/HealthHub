...
//                   <h1>Transforming lives and </h1>
//                   <h1>Nurturing planets.</h1>
//                 </div>
...
//                   <b className={styles.btn}><Link to='/register'> Get Started</Link></b>
//                 </div>
//               </div>
//               <div className={styles.right}>
//                 <img className={styles.hero} src={healthhub} alt="avatar" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//                 </div>
//               </div>
//               <div className="mx-auto max-w-screen-sm text-sm text-center text-gray-500 newsletter-form-footer dark:text-gray-300">We care about the protection of your data 
//                 <Link to="/" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Read our Privacy Policy</Link>.
//               </div>
//             </form>
//           </div>
//         </section>
        ...
        <div className={styles.bigwrapper}>
          <div className={styles.showcasearea}>
            <div className={styles.container}>
              <div className={styles.left}>
                <div className={styles.bigtitle}>
                  <h1><b>Transforming lives and</b> </h1>
                  <h1><b>Nurturing planets.</b></h1>
                </div>
                <p className={styles.text}>
                  <b className='text-gray-700'> Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Delectus eius distinctio odit, magni magnam qui ex perferendis
                  vitae!</b>
                </p>
                <div className={styles.cta}>
                  <b className={styles.btn}><Link to='/preregister'> Get Started</Link></b>
                </div>
              </div>
              <div className={styles.right}>
                <img className={styles.hero} src={healthhub} alt="avatar" />
